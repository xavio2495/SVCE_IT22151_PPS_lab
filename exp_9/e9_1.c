...
#include <stdio.h>
void print_int(int num){printf("Roll Number: %d\n", num);}
void print_float(float num){printf("GPA: %.2f\n", num);}
void print_char(char ch){printf("Gender: %c\n", ch);}
void print_string(char *str){printf("Name: %s\n", str);}
void main()
{
    int roll_no;
    float GPA;
